...
public class Hygrometer extends Sensor implements SimpleValueSensor<Float> {
    ...
    private io.patriot_framework.generator.device.passive.sensors.SimpleSensor device = new io.patriot_framework.generator.device.impl.basicDevices.Hygrometer();
    private String unit;
