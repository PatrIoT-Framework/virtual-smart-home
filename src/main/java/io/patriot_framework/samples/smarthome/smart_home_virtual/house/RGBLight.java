 ...
 */
public class RGBLight extends MultiStateActuator implements Switchable {
    private int red;     // values E [0, 100]
    private int green;  // values E [0, 100]
    private int blue;  // values E [0, 100]
