...
public final class HouseBean {
    ...
    public void objInfo(Exchange exchange) {
        ...
        if (exchange.getProperty("type").equals(Ac.class.getSimpleName())) {
        ...
        } else if (exchange.getProperty("type").equals(DHT11Device.class.getSimpleName())) {
            System.out.println("exchange = " + exchange);
            object = house.getDeviceWithId("dhtsensor", DHT11Device.class);
            ...
            System.out.println("fucking object");
    ...
    public String getTemp() {
        return String.valueOf(house.getDeviceWithId("temp", Thermometer.class).getValue());
    }
